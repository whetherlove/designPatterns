...
&emsp;[简单/静态工厂模式（Simple/Static Factory Pattern）](https://github.com/whetherlove/designPatterns/tree/master/src/GoF/decoratorPattern)/
      [工厂方法模式（Factory Method Pattern）](https://github.com/whetherlove/designPatterns/tree/master/src/GoF/decoratorPattern)/
      [抽象工厂模式（Abstract Factory Pattern）](https://github.com/whetherlove/designPatterns/tree/master/src/GoF/decoratorPattern)
<br />
